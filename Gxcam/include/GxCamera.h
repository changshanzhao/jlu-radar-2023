...
public:
	...
	*/
	...
	/**
	* @beief: set Trigger Mode
	* @return: 获取状态
	*/
	GX_STATUS setTriggerGrab(GX_DEV_HANDLE& camHandle_,bool is_trigger);

	/**
	* @beief: print Frame Info
	* @param: camIndex 相机SN号
	* @return: 获取状态
	*/
	GX_STATUS printFrameInfo();
	...
	* @return: 获取状态
	*/
	GX_STATUS snapCvMat(Mat & dstCvMat,GX_DEV_HANDLE& camHandle_);
...
private:
	...
	string CamIndex_;  //相机SN号

	uint64_t cam_time = 0; //using for print timestamp
